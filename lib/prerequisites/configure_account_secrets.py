...
from lib.configuration import DEPLOYMENT, GITHUB_TOKEN_NAME, get_all_configurations
...
if __name__ == '__main__':
    ...
    response = input((
        ...
        f'{get_all_configurations()[DEPLOYMENT][GITHUB_TOKEN_NAME]} '
    ...
    if response.lower() == 'y':
        ...
        secret_name = get_all_configurations()[DEPLOYMENT][GITHUB_TOKEN_NAME]
